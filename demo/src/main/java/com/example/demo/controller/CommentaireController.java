...
import com.example.demo.services.CommentaireServiceImpl;
...
public class CommentaireController {
    ...
    @PostMapping("/create")
public ResponseEntity<?> createComment(@RequestParam Long postId, @RequestBody Map<String, String> request) {
